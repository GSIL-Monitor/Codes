...
#logger
loghelper.init_logger("collection_microsoft", stream=True)
logger = loghelper.get_logger("collection_microsoft")

COLLECTION_ID = 544
def process():
    logger.info("Process collection microsoft")
    ...
    logger.info("End process collection microsoft")
