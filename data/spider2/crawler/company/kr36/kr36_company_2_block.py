...
#logger
loghelper.init_logger("crawler_36kr_company2_block", stream=True)
logger = loghelper.get_logger("crawler_36kr_company2_block")
...
columns = [
    {"column": 667},{"column": 65},{"column": 975},{"column": 162},{"column": 6701},{"column": 331},{"column": 135}
...
def run(flag, column, listcrawler, companycrawler, concurrent_num):
    ...
    while True:
        ...
        url = 'https://rong.36kr.com/n/api/label/%s/company?p=%s&sortField=HOT_SCORE' % (column["column"],key)
        while True:
