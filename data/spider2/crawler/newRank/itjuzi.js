...
if(system.args.length < 1){
    ...
    stt = system.args[1];
    console.log(stt)
//    var xyz = newrank_md5(stt)
//    console.log('xyz='+xyz)
//    return xyz
//    phantom.exit();
}
var arg1 = 'B6298D8EB8C2D9636E56A4AFE4854F1905A45015';
...
var _0x55f3 = function (arr1, func1) {
    var arr1 = parseInt(arr1, 0x10);
    var _0x48181e = _0x4818[arr1];
    ...
    if (_0x55f3['data'][arr1] === undefined) {
        if (!_0x55f3['once']) {
        ...
        _0x48181e = _0x55f3['rc4'](_0x48181e, func1);
        _0x55f3['data'][arr1] = _0x48181e;
    } else {
        _0x48181e = _0x55f3['data'][arr1];
    }
    return _0x48181e;
};
var arg3 = null;
...
if (function () {
        var _0x470d8f = function () {
            ...
            return function (func1, func2) {
                var _0x48181e = arr1 ? function () {
                    if (func2) {
                        var _0x55f3be = func2['apply'](func1, arguments);
                        func2 = null;
                        return _0x55f3be;
                    }
                } : function () {
        ...
        var _0x501fd7 = _0x470d8f(this, function () {
            ...
            var _0x55f3be = function () {
                return !_0x3ad9a1['test'](arr1['toString']());
            };
            var _0x1b93ad = function () {
                var _0x20bf34 = new RegExp('(\\[x|u](\w){2,4})+');
                return _0x20bf34['test'](func1['toString']());
            };
