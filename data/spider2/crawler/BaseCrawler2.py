...
#logger
loghelper.init_logger("BaseCrawler2", stream=True)
logger = loghelper.get_logger("BaseCrawler2")
...
class BaseCrawler:
    ...
    def is_crawl_success(self,url, content, redirect_url=None):
        return True
    ...
    def crawl(self, url, headers={}, cookies=None, postdata=None, redirect=True, login=True, agent=False):
        ...
        try:
            ...
            if content_length is None:
                if self.is_crawl_success(url, content,redirect_url):
