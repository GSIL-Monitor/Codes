...
#logger
loghelper.init_logger("crawler_liancaijing_news", stream=True)
logger = loghelper.get_logger("crawler_liancaijing_news")
...
URLS = []
CURRENT_PAGE = 1
linkPattern = "liancaijing.com/\d+.html"
Nocontents = [
]
columns = [
    # {"column": "jmd", "max": 2},
...
if __name__ == "__main__":
    if len(sys.argv) > 1:
        ...
        if param == "incr":
            ...
            crawler_news({}, NewsCrawler(), link, 'http://liancaijing.com/wp-content/themes/M1/timthumb.php?src=http://liancaijing.com/wp-content/uploads/2018/03/Economy-193.jpg&w=220&h=165&zc=1', [], download_crawler)
    else:
        start_run(1, "incr")