...
#logger
loghelper.init_logger("szse_company_parser_2", stream=True)
logger = loghelper.get_logger("szse_company_parser_2")
...
def process():
    logger.info("szse_company_parser begin...")
    ...
    logger.info("szse_company_parser end.")
