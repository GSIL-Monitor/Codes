            ...
            for jobpage in item["content"][type]:
                ...
                for job_content in jobs:
                    ...
                    source_job = {
                        ...
                        "jobNature": job_content.get("jobNature"),
                        "positionAdvantage": job_content.get("positionAdvantage"),
                        "companyLabelList": job_content.get("companyLabelList",[]),
                        "financeStage": job_content.get("financeStage"),
                        "district": job_content.get("district"),
                    }
