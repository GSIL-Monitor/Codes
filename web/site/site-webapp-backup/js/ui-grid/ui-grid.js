      ...
      return {
        post: function ($scope, $elm, $attrs, uiGridCtrl) {
          ...
          function setup() {
            ...
            // customize
            $scope.$watch(function () { return angular.element($('body')).hasClass('mini-navbar')},function (newValue, oldValue) {
          ...
          function gridResize($event) {
        	...
        	grid.gridHeight = windowHeight-190;
        	
        	var mini =angular.element($('body')).hasClass('mini-navbar');
        	var small =angular.element($('body')).hasClass('body-small');
        	if(small){
        		grid.gridWidth = $scope.gridWidth = windowWidth-30;
        	}else if(mini){
        		grid.gridWidth = $scope.gridWidth = windowWidth-100;
        	}else{
        		grid.gridWidth = $scope.gridWidth = windowWidth-230;
        	}
