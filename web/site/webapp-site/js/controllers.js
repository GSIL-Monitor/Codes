...
//
//		if($scope.company.userCompanyRel == null){
//			$scope.status = 1401;
//			$scope.start = today;
//
//		}
//		else {
//			$scope.status = $scope.company.userCompanyRel.followStatus;
//			var start = $scope.company.userCompanyRel.followStart;
//			if(start != null){
...
//
//		var text;
//		$http.get('./api/common/followStatus').success(function(data){
//
...
//
//
//		$scope.descAll = data.company.companyDesc.split(/\r?\n/);
//
//		var count = 0;
//		var desc = [];
//		var flag = false;
...
//		})
//
//		$http.get('./api/user/list/getExsiting?code='+code).success(function(data){
...
//
//		if($scope.company.userCompanyRel != null){
//			console.log($scope.company.userCompanyRel.heart=='Y')
//			if(status == $scope.status && start == $scope.start && $scope.company.userCompanyRel.heart=='Y') return;
//		}
//
//		var req = {	method: 'put',
//			url: './api/user/company/updateFollow',
...
//
//		if($scope.company.userCompanyRel != null){
//			var oldNote = $scope.company.userCompanyRel.note;
...
//
//		var req = {	method: 'put',
//					url: './api/user/company/updateNote',
//					params: { code: code, note: note}
//			      }
//		$http(req).success(function(data){
//			$scope.company.userCompanyRel.note = note;
//		}).then(function(){
//			$('.heart').addClass('fa-heart');
//			$('.heart').removeClass('fa-heart-o');
	 ...
	 $scope.open = function (template) {
	    ...
	    modalInstance.result.then(function (callBack) {
	    	...
	    	if(template == 'list'){
	        	...
	        	var req = {
		   				 method: 'put',
		   				 url: pre_address+'/api/site/company/list/add',
