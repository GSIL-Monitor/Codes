...
const PreScoreEndDate = React.createClass({
    ...
    render(){
        ...
        if (!Functions.isEmptyObject(this.state)) {
            var validate = this.state.validate.preScoreEndDate;
        ...
        return <FormInput label='初筛截止日期'
                          name='preScoreEndDate'
                          className={className}
...
module.exports = PreScoreEndDate;