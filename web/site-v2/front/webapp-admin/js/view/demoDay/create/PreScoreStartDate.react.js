...
const PreScoreStartDate = React.createClass({
    ...
    render(){
        ...
        if (!Functions.isEmptyObject(this.state)) {
            var validate = this.state.validate.preScoreStartDate;
        ...
        return <FormInput label='初筛选日期'
                          name='preScoreStartDate'
                          className={className}
...
module.exports = PreScoreStartDate;